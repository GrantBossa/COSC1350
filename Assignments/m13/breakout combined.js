...
yourScore = 0;
yourLevel = 1;
oldX = 0;               // placeholder for mouse position to determine left or right
...
document.addEventListener('mousemove', (event) => {
   ...
   console.log('mousemove', oldX, ' x ', event.x, ' y ', event.y,'\n screen',' x ', event.screenX, ' y ', event.screenY, '\ndiff ',event.movementX, event.offsetX);
