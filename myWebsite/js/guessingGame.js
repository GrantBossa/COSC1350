...
// set screen display for guess limit line upon loading
document.getElementById("guessCount").innerHTML = guessCount;
document.getElementById("guessLimit").innerHTML = guessLimit ;
...
function processGuess() {
   ...
   if (guessCount <= guessLimit) {
      ...
      if (inputGuess === myNumber) {
         ...
         alert("Guess number " + guessCount + " : " + inputGuess +"\n Was too low! Try again.");
      } else {
      ...
      alert( "Game Over! You ran out of turns. The correct number was " + myNumber  );
      gameOverProcessing();
      return ;  
   }
   ...
   function gameOverProcessing() {
      ...
      if (answer) {
         alert("Great, me too!/n/nI'll reset the game.");
      } else {
